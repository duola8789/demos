!(function (a, b) {
  ...
  return (function (a) {
    ...
    function (a, b, c) {
      c(38), c(37), c(39), (a.exports = c(109));
    },
    function (a, b, c) {
      var d, e;
      (d = []),
    ...
    function (a, b, c) {
      ...
      (d = [c(8), c(1), c(63), c(27), c(15), c(42), c(65), c(62), c(44), c(123), c(126), c(124)]),
        void 0 !==
          (e = function (a, b, c, d, e, g, h, i, j, k, l, m) {
            var n = {};
            return (
              (n.log = function () {
                window.console &&
                  ('object' === f(console.log)
              ...
              (n.foreach = function (a, b) {
                var c, d;
                for (c in a)
                  'function' === n.typeOf(a.hasOwnProperty)
        ...
        void 0 !==
          (e = function (a) {
            var b = [],
              ...
              d = {
                on: function (a, b, c) {
                  return g(this, 'on', a, [b, c]) && b
                    ? (this._events || (this._events = {}),
                      (this._events[a] || (this._events[a] = [])).push({callback: b, context: c}),
                      this)
                    : this;
                },
                once: function (b, c, d) {
                    ...
                    if (((b = i[j]), (h = this._events[b]))) {
                      if (((this._events[b] = e = []), c || d))
                        for (l = 0, m = h.length; l < m; l++)
                          (f = h[l]),
                            ((c && c !== f.callback && c !== f.callback._callback) || (d && d !== f.context)) &&
                              e.push(f);
        ...
        void 0 !==
          (e = function (a, b, c, d) {
            ...
            function f(a) {
              ...
              return (
                !!(d.isPoorIE() || a instanceof MouseEvent) &&
                ('which' in b ? 3 === b.which : 'button' in b && 2 === b.button)
              );
            }
            function g(a, b, c) {
              var e;
              e =
                (!d.isPoorIE() && b instanceof MouseEvent) || (!b.touches && !b.changedTouches)
                  ? b
            ...
            function h(a) {
              (d.isPoorIE() || a instanceof MouseEvent || a instanceof window.TouchEvent) &&
            ...
            var i = !c.isUndefined(window.PointerEvent),
              ...
              m = function (a, j) {
                ...
                function o(c) {
                  (k || (i && 'touch' !== c.pointerType && !a.contains(document.elementFromPoint(c.x, c.y)))) &&
                    s(b.touchEvents.OUT, c);
                }
                function p(b) {
                  (t = b.target),
                    (x = e(b, 'X')),
                    ...
                    f(b) ||
                      (i
                        ? b.isPrimary &&
                          (j.preventScrolling && ((u = b.pointerId), a.setPointerCapture(u)),
                          d.addEventListener(a, 'pointermove', q),
                          d.addEventListener(a, 'pointercancel', r),
                          d.addEventListener(a, 'pointerup', r))
                        : k &&
                          (d.addEventListener(document, 'mousemove', q),
                          l && 'object' === b.target.nodeName.toLowerCase()
                            ? d.addEventListener(a, 'click', r)
                            : d.addEventListener(document, 'mouseup', r)),
                      t &&
                        (d.addEventListener(t, 'touchmove', q),
                ...
                function r(c) {
                  var e = b.touchEvents;
                  i
                    ? (j.preventScrolling && a.releasePointerCapture(u),
                      d.removeEventListener(a, 'pointermove', q),
                      d.removeEventListener(a, 'pointercancel', r),
                      d.removeEventListener(a, 'pointerup', r))
                    : k &&
                      (d.removeEventListener(document, 'mousemove', q), d.removeEventListener(document, 'mouseup', r)),
                    t &&
                      (d.removeEventListener(t, 'touchmove', q),
                      d.removeEventListener(t, 'touchcancel', r),
                      d.removeEventListener(t, 'touchend', r)),
                    w
                      ? s(e.DRAG_END, c)
                      : (j.directSelect && c.target !== a) ||
                ...
                (j = j || {}),
                  i
                    ? (d.addEventListener(a, 'pointerdown', p),
                      j.useHover && (d.addEventListener(a, 'pointerover', m), d.addEventListener(a, 'pointerout', o)),
                      j.useMove && d.addEventListener(a, 'pointermove', n))
                    : k &&
                      (d.addEventListener(a, 'mousedown', p),
                      j.useHover && (d.addEventListener(a, 'mouseover', m), d.addEventListener(a, 'mouseout', o)),
            ...
            return (
              ...
              e.extend(f.prototype, {
                reorderProviders: function () {
                  var a, b, c, d;
                  'flash' === this.config.primary &&
                    ((a = e.indexOf(this.providers, e.findWhere(this.providers, {name: 'flash'}))),
                    (b = this.providers.splice(a, 1)[0]),
                    (c = e.indexOf(this.providers, e.findWhere(this.providers, {name: 'html5'}))),
                    this.providers.splice(c, 0, b)),
                    'videojs' === this.config.primary &&
                      ((a = e.indexOf(this.providers, e.findWhere(this.providers, {name: 'flash'}))),
                      (b = this.providers.splice(a, 1)[0]),
                      (c = e.indexOf(this.providers, e.findWhere(this.providers, {name: 'html5'}))),
                ...
                required: function (a, b) {
                  return (
                    (a = a.slice()),
                    e.compact(
                      e.map(this.providers, function (c) {
          ...
          (e = function (a, b) {
            return a.extend({
              ...
              openTooltip: function (a) {
                this.trigger('open-' + this.componentType, a, {isOpen: !0}),
                  (this.isOpen = !0),
                  b.toggleClass(this.el, this.openClass, this.isOpen);
              },
              closeTooltip: function (a) {
                this.trigger('close-' + this.componentType, a, {isOpen: !1}),
                  (this.isOpen = !1),
                  b.toggleClass(this.el, this.openClass, this.isOpen);
              },
    ...
    function (a, b, c) {
      ...
      (d = [c(8)]),
        void 0 !==
          (e = function (a) {
            var b = {},
              c = (b.pluginPathType = {ABSOLUTE: 0, RELATIVE: 1, CDN: 2});
            return (
          ...
          (e = function (a, b, c) {
            ...
            return (
              ...
              (d.bounds = function (a) {
                ...
                return c.width || c.height || c.left || c.top
                  ? ((b.left = c.left + e),
                    (b.right = c.right + e),
                    (b.top = c.top + d),
                    (b.bottom = c.bottom + d),
                ...
                function g(a, b) {
                  ...
                  switch (a) {
                    ...
                    case h.JWPLAYER_MEDIA_TYPE:
                      return void (
                        this.mediaModel.get('mediaType') !== b.mediaType &&
                        (this.mediaModel.set('mediaType', b.mediaType), this.mediaController.trigger(a, c))
                      );
                ...
                (this.mediaController = e.extend({}, f)),
                  ...
                  (this.recordMediaPosition = function (a, b) {
                    ...
                    c &&
                      ...
                      b > 0 &&
                      !1 !== isFinite(b) &&
                      e.each(n.sources, function (c) {
                        a < b && a > 2
                          ? o.setItem('filePostion.' + c.file, a)
                          : a >= b && o.clearItem('filePostion.' + c.file);
                      });
                  }),
                  (this.getLastPosition = function (b) {
                    ...
                    return (
                      b &&
                        'array' === a.typeOf(b.sources) &&
                        b.sources.length > 0 &&
                        o.getItem('filePostion.' + b.sources[0].file) &&
                        (c = o.getItem('filePostion.' + b.sources[0].file)),
                      c
                    );
                  }),
                  ...
                  (this.changeVideoProvider = function (a) {
                    ...
                    if (
                      ...
                      return (m = q = a), void this.set('provider', void 0);
                    ...
                    c ? q.setContainer(c) : this.once('change:mediaContainer', this.onMediaContainer),
                      ...
                      -1 === q.getName().name.indexOf('flash') &&
                  ...
                  (this.setToken = function (a) {
                    ...
                    'string' == typeof arguments[0] &&
                      ...
                      ((b[0] = {file: arguments[0], tokenText: arguments[1]}), (a = b)),
                  ...
                  (this.loadVideo = function (a) {
                    ...
                    (a.starttime = this.getLastPosition(a)),
                      ...
                      this.mediaController.trigger(h.JWPLAYER_MEDIA_PLAY_ATTEMPT, {playReason: this.get('playReason')}),
                      m.load(a);
                  }),
                  ...
                  switch (
                    ...
                    case 'object':
                      ...
                      if (j && 'object' === (void 0 === j ? 'undefined' : f(j)))
                        for (l = j.length, e = 0; e < l; e += 1)
                          'string' == typeof j[e] && ((i = j[e]), (k = c(i, o)) && m.push(b(i) + (g ? ': ' : ':') + k));
                      else
                        for (i in o)
                ...
                'function' != typeof JSON.stringify &&
                  ...
                  (JSON.stringify = function (a, b, d) {
                    ...
                    if (
                      ...
                      b &&
                        'function' != typeof b &&
                        ('object' !== (void 0 === b ? 'undefined' : f(b)) || 'number' != typeof b.length))
                    )
                        ...
                        if (h && 'object' === (void 0 === h ? 'undefined' : f(h)))
                          for (e in h)
                            Object.prototype.hasOwnProperty.call(h, e) &&
                              ((g = c(h, e)), void 0 !== g ? (h[e] = g) : delete h[e]);
                        return b.call(a, d, h);
                      }
                      var e;
                      if (
          ...
          (e = function (a) {
            ...
            (c.prototype['catch'] = function (a) {
              ...
              (c.resolve = function (a) {
                return a && 'object' === (void 0 === a ? 'undefined' : f(a)) && a.constructor === c
                  ? a
                  : new c(function (b) {
                      b(a);
                    });
              ...
              b.extend(this, g, {
                ...
                getSwfObject: function (a) {
                  ...
                  return b
                    ...
                    : e.embed(k.flashplayer, a, h(j), k.wmode, k.playlistItem, k.flashUI);
                },
                ...
                setContainer: function (e) {
                  if (q !== e) {
                    ...
                    r.on(
                      ...
                      r.on(
                        c.JWPLAYER_CONNECT_FAILD,
                        function (a) {
                          g.trigger.call(D, 'connectFaild', a),
                            g.trigger.call(D, c.JWPLAYER_MEDIA_ERROR, {message: '连接已断开，请稍后重试'});
                        },
                        this
                      ),
                      r.on(
        ...
        void 0 !==
          (e = function (a, b, c, d, e, f, g, h, i) {
            ...
            function m(m, x) {
                ...
                n(wa),
                  ...
                  ya &&
                    (sa.state === f.STALLED
                      ...
                      : sa.state === f.PLAYING && (wa = setTimeout(aa, o)),
                    (Aa && Ma.duration === 1 / 0 && 0 === Ma.currentTime) ||
                      (I(H()),
                      G(Ma.currentTime),
                      F(ba(), pa, oa),
                      sa.state === f.PLAYING &&
                        (sa.trigger(e.JWPLAYER_MEDIA_TIME, {position: pa, duration: oa}), E())));
              }
              function E() {
                var a = Ia.level;
              ...
              function F(a, b, c) {
                (a === xa && c === oa) ||
                  ((xa = a), sa.trigger(e.JWPLAYER_MEDIA_BUFFER, {bufferPercent: 100 * a, position: b, duration: c}));
              }
              function G(a) {
                oa < 0 && (a = -(Z() - a)), (pa = a);
              }
              ...
              function P() {
                Aa ||
                  Ma.paused ||
                  Ma.ended ||
                  (sa.state !== f.LOADING && sa.state !== f.ERROR && (sa.seeking || sa.setState(f.STALLED)));
              }
              function Q() {
                if (ya) {
                  ...
                  b.isMobile() &&
                    ...
                    Ka.tokenEncrypt &&
                    !b.isFlvjsSupported() &&
                    (a = '当前系统及浏览器环境不支持“token加密”的hls视频播放'),
                    sa.trigger(e.JWPLAYER_MEDIA_ERROR, {message: a, code: '111', detail: Ma.error, videoSrc: Ma.src});
                }
              }
              function R(a) {
                var c;
              ...
              function T(a) {
                var b = Math.max(0, za),
                  c = x.qualityLabel;
                if (a)
                  for (var d = 0; d < a.length; d++) if ((a[d]['default'] && (b = d), c && a[d].label === c)) return d;
              ...
              function V(a, c) {
                ...
                e || 'none' === g || 'started' === g
                  ? ((oa = c),
                    ...
                    b.isHtml5Flv(ra[za].file, ra[za].type) && Ja ? (Ja.load(), Ja.play()) : (W(ra[za]), Ma.load()),
                    s && Ma.paused && U())
                  : (0 === a && Ma.currentTime > 0 && ((va = -1), sa.seek(a)),
              ...
              function ia(a) {
                if (((Ea = null), a)) {
                  ...
                  sa.addTracksListener(a, 'change', fa),
                    Ea && sa.trigger('audioTracks', {currentTrack: Fa, tracks: Ea});
                }
              }
              function ja(a) {
                Ma &&
                  ...
                  Ea &&
                  a > -1 &&
                  a < Ma.audioTracks.length &&
                  a !== Fa &&
                  ((Ma.audioTracks[Fa].enabled = !1),
                  (Fa = a),
                  (Ma.audioTracks[Fa].enabled = !0),
                  sa.trigger('audioTrackChanged', {currentTrack: Fa, tracks: Ea}));
              }
              function ka() {
                return Ea || [];
              }
              ...
              (Ma = Ma || document.createElement('video')),
                ...
                (this.initFlvPlayer = function () {
                  ...
                  Ka.minBufferLength > 0 &&
                    ((b.lazyLoadMaxDuration = Ka.minBufferLength),
                    Ka.minBufferLength < 30 && (b.lazyLoadRecoverDuration = Ka.minBufferLength));
                  var c = d.extend(
                    {hasAudio: !0, hasVideo: !0, isLive: Ka.isLive, type: 'flv', url: ra[za].file, withCredentials: !1},
                    Ka.flvjs || {}
                  );
                ...
                (this.play = function () {
                  return sa.seeking
                    ? (sa.setState(f.LOADING), void sa.once(e.JWPLAYER_MEDIA_SEEKED, sa.play))
                    : void U();
                }),
                (this.pause = function () {
                ...
                (this.seek = function (a) {
                  if (ya)
                    if (
                      (a < 0 && (a += Y() + Z()),
                      0 === va && this.trigger(e.JWPLAYER_MEDIA_SEEK, {position: Ma.currentTime, offset: a}),
                      ua || (ua = !!Z()),
                      ua)
                    ) {
                      va = 0;
                ...
                (this.setVisibility = function (b) {
                  (b = !!b),
                    b || t
                      ? a.style(na, {visibility: 'visible', opacity: 1})
                      : a.style(na, {visibility: '', opacity: 0});
                }),
                (this.resize = function (b, c, d) {
                  ...
                  if ('uniform' === d) {
                    ...
                    Math.abs(f - g) < 0.09 && ((e.objectFit = 'fill'), (d = 'exactfit'));
                  }
                  if (p || t || u || v) {
                    ...
                    'none' === d
                      ...
                      a.transform(
                        Ma,
                        'translate(' + h + 'px, ' + i + 'px) scale(' + j.toFixed(2) + ', ' + k.toFixed(2) + ')'
                      );
                  }
                ...
                (this.setCurrentQuality = function (a) {
                  if (za !== a && a >= 0 && ra && ra.length > a) {
                    (za = a),
                      (Ia.reason = 'api'),
                      (Ia.level = {}),
                      this.trigger(e.JWPLAYER_MEDIA_LEVEL_CHANGED, {currentQuality: a, levels: R(ra)}),
      ...
      (d = [c(1), c(44)]),
        void 0 !==
          (e = function (a, b) {
            ...
            var e = {};
            return (
              (e.getAbsolutePath = function (a, d) {
                if ((b.exists(d) || (d = document.location.href), b.exists(a))) {
                  if (c(a)) return a;
                  var e,
                    f = d.substring(0, d.indexOf('://') + 3),
                ...
                try {
                  'DOMParser' in window
                    ? ((b = new window.DOMParser().parseFromString(a, 'text/xml')),
                      (d(b.childNodes) || (b.childNodes && d(b.childNodes[0].childNodes))) && (b = null))
            ...
            return a.extend({
              ...
              setup: function () {
                ...
                (this.el = d.createElement(c(a))),
                  ...
                  (this.userInteract = new b(this.element(), {preventScrolling: !0})),
              ...
              dragMove: function (a) {
                ...
                'horizontal' === this.orientation
                  ? ((b = a.pageX),
                    (c = b < e.left ? 0 : b > e.right ? 100 : 100 * d.between((b - e.left) / e.width, 0, 1)))
                  : ((b = a.pageY),
                    (c =
                      b >= e.bottom
                        ? 0
            ...
            var f = [],
              ...
              h = function (b) {
                ...
                return (
                  b
                    ? 'string' == typeof b
                      ? (c = i(b)) || (d = document.getElementById(b))
                      : 'number' == typeof b
                      ? (c = f[b])
                      : b.nodeType && ((d = b), (c = i(d.id)))
                    : (c = f[0]),
                  c || (d ? j(new a(d, k)) : {registerPlugin: e.registerPlugin})
                );
              },
              i = function (a) {
          ...
          (e = function (a, b, c, d, e, f) {
            return function () {
              function g(e) {
                c.tryCatch(function () {
                  var c,
                    g = e.responseXML ? e.responseXML.childNodes : null,
                    h = '';
                  if (g) {
                    for (var k = 0; k < g.length && ((h = g[k]), 8 === h.nodeType); k++);
                    'xml' === a.localName(h) && (h = h.nextSibling),
                      'rss' === a.localName(h) && (c = {playlist: b.parse(h)});
                  }
                  if (!c)
                    try {
                      var l = JSON.parse(e.responseText);
                      if (f.isArray(l)) c = {playlist: l};
                      else {
      ...
      (d = [c(2), c(8), c(1)]),
        void 0 !==
          (e = function (a, b, c) {
            ...
            return function (e) {
              if (e && e.file) {
                (a.isRtmp(e.file) || a.isFlv(e.file)) &&
                  a.isMobile() &&
                  e.fallbackfile &&
                  a.isHls(e.fallbackfile) &&
                  (e.file = e.fallbackfile),
                  a.isMobile() ||
                    a.isFlvjsSupported() ||
                    (!a.isHls(e.file) && !a.isFlv(e.file)) ||
                    !e.fallbackfile ||
                    (e.file = e.fallbackfile);
                var f = c.extend({}, d, e);
                ...
                if (
                  (a.isRtmp(f.file)
                    ? (f.type = 'rtmp')
                    : g.test(f.type)
                    ? (f.type = f.type.replace(g, '$1'))
                    : f.type || (f.type = b.extension(f.file)),
                  f.type)
                ) {
                  switch (f.type) {
                    case 'm3u8':
              ...
              (this.load = function () {
                if (r === e.loaderstatus.NEW) {
                  if (i.lastIndexOf('.swf') > 0)
                    return (m = i), (r = e.loaderstatus.COMPLETE), void q.trigger(c.COMPLETE);
                  if (b.getPluginPathType(i) === b.pluginPathType.CDN)
                    return (r = e.loaderstatus.COMPLETE), void q.trigger(c.COMPLETE);
                  ...
                  if (m)
                    switch (b.getPluginPathType(m)) {
                      case b.pluginPathType.ABSOLUTE:
                        return m;
                      case b.pluginPathType.RELATIVE:
                        return i.lastIndexOf('.swf') > 0
                          ? a.getAbsolutePath(m, window.location.href)
                          : a.getAbsolutePath(m, j());
                    }
                  return null;
                }),
                (this.getJS = function () {
                ...
                (this.getPluginmode = function () {
                  return void 0 !== (void 0 === m ? 'undefined' : f(m)) &&
                    void 0 !== (void 0 === n ? 'undefined' : f(n))
                    ? h.HYBRID
                    : void 0 !== (void 0 === m ? 'undefined' : f(m))
                    ? h.FLASH
                    : void 0 !== (void 0 === n ? 'undefined' : f(n))
                    ? h.JAVASCRIPT
                    : void 0;
          ...
          (e = function (a, b, c) {
            ...
            return [
              ...
              },
              {
                ...
                supports: function (b) {
                  return (
                    !(a.isChrome() && parseInt(a.getChromeVersion()) < 50) &&
                    window.videojs &&
                    window.videojs.MediaSource &&
                    window.videojs.MediaSource.supportsNativeMediaSources() &&
                    a.isHls(b.file, b.type)
                  );
                }
              },
              {
          ...
          (e = function (a, b, c, d) {
                  ...
                  (a.each(
                    ...
                    function (a) {
                      a.startTime < e ||
                        (a.data
                          ? f.push(a)
                          : a.text && this.trigger('meta', {metadataTime: e, metadata: JSON.parse(a.text)}));
                    },
                    this
                  ),
                  f.length)
            ...
            function g(a) {
              ...
              !this._isSDK &&
                b &&
                a &&
                (h.call(this, a) || (r(), d.emptyElement(this.video), i(), (this.itemTracks = a), j.call(this, a)));
            }
            function h(a) {
                    ...
                    if (/subtitles|captions|descriptions|chapters|metadata/i.test(e.kind)) {
                      b ||
                        (!this.video.hasAttribute('crossorigin') &&
                          c.crossdomain(e.file) &&
                          (this.video.setAttribute('crossorigin', 'anonymous'), (b = !0)));
            ...
            function l(b) {
              t &&
                ...
                v !== b - 1 &&
                  ...
                  this.trigger('subtitlesTrackChanged', {currentTrack: v + 1, tracks: t})));
            }
            function m() {
              return v;
            }
        ...
        void 0 !==
          (e = function (a, b) {
              ...
              return function (b) {
                ...
                if (4 === c.readyState) {
                  if ((clearTimeout(a.timeoutId), c.status >= 400)) {
                    var d;
                    return (
                      (d = 404 === c.status ? 'File not found' : c.status + '(' + c.statusText + ')'),
                      a.onerror(d, a.url, c)
                    );
                  }
            ...
            function h(b, c, d) {
              ...
              return d.requireValidXML && ('parsererror' === e.nodeName || e.getElementsByTagName('parsererror').length)
                ? void d.onerror('Invalid XML', d.url, b)
                : (b.responseXML || (b = a.extend({}, b, {responseXML: c})), d.oncomplete(b));
            }
            var i = function () {},
              j = !1,
              k = function (a) {
        ...
        void 0 !==
          (e = function (a) {
            ...
            var f = (c.isIETrident = function (a) {
                return (
                  !!c.isEdge() ||
                  (a ? ((a = parseFloat(a).toFixed(1)), d(new RegExp('trident/.+rv:\\s*' + a, 'i'))) : d(/trident/i))
                );
              }),
            ...
            var i = (c.isIOS = function (a) {
              return d(
                a ? new RegExp('iP(hone|ad|od).+\\s(OS\\s' + a + '|.*\\sVersion/' + a + ')', 'i') : /iP(hone|ad|od)/i
              );
            });
            ...
            var j = (c.isAndroid = function (a, b) {
              return (
                !(b && d(/chrome\/[123456789]/i) && !d(/chrome\/18/)) &&
                (a ? (e(a) && !/\./.test(a) && (a += '.'), d(new RegExp('Android\\s*' + a, 'i'))) : d(/Android/i))
              );
            });
            return (
              (c.isMobile = function () {
          ...
          (e = function (a) {
            ...
            return (
              ...
              (b.utf16BigEndianArrayToStr = function (a, b) {
                var c, d, e;
                for (c = '', e = a.length - 1, d = b || 0; d < e; )
                  (254 === a[d] && 255 === a[d + 1]) || (c += String.fromCharCode((a[d] << 8) + a[d + 1])), (d += 2);
                return c;
              }),
                  ...
                  function (d, e) {
                    if (!('value' in e) && 'data' in e && e.data instanceof ArrayBuffer) {
                      ...
                      for (var i = 10; i < 14 && i < g.length && 0 !== g[i]; )
                        (e.value.key += String.fromCharCode(g[i])), i++;
                      var j = 19,
                        k = g[j];
                      (3 !== k && 0 !== k) || ((k = g[++j]), h--);
                      var l = 0;
                      ...
                      if (l > 0) {
                        ...
                        var q = g[j];
                        e.value.data =
                          1 === q || 2 === q ? b.utf16BigEndianArrayToStr(g, j + 1) : b.utf8ArrayToStr(g, j + 1);
                      }
                    }
                ...
                (o = new g(m)),
                  ...
                  o.on(a.JWPLAYER_ERROR, function (a) {
                    if (
                      ...
                      d.isMp4(a.videoSrc) &&
                      a.detail &&
                      ('DEMUXER_ERROR_COULD_NOT_OPEN: FFmpegDemuxer: open context failed' === a.detail.message ||
                        4 === a.detail.code)
                    ) {
      ...
      (d = [c(2), c(1)]),
        void 0 !==
          (e = function (a, b) {
            ...
            function f(b) {
              return (
                (a.isMSIE(7) || a.isMSIE(6)) && (b.flashUI = !0),
                (b.skin = 'bce'),
                (b.startseek = !1),
            ...
            var h = {
              ...
              width: 480,
              height: 270,
              controlbar: {barLogo: !1, barLogoUrl: 'https://cloud.baidu.com/solution/media.html', canDrag: !0},
      ...
      var f = c(175),
        ...
        n = (function () {
          function a(b) {
            e(this, a),
              (this.api = null),
              b && b.advs && i['default'].isArray(b.advs) && b.advs.length
                ? ((this.processAdvs = b.advs),
                  (this.hasProcessAdv = !0),
                  (this.el = k['default'].createElement((0, g['default'])())))
                : (this.hasProcessAdv = !1),
              (this.activeAdv = null);
          }
          return (
            (a.prototype.setApi = function (a) {
              this.api = a;
            }),
              ...
              for (var c = {}, d = a.substr(a.indexOf('?') + 1).split('&'), g = 0; g < d.length; g++) {
                ...
                if (i > -1) {
                  ...
                  b.contains(e, j) &&
                    ((k = k.replace(/'/g, '"')),
                    (k =
                      'object' === ('undefined' == typeof JSON ? 'undefined' : f(JSON)) &&
                      'function' == typeof JSON.parse
                        ? JSON.parse(k)
                        : eval('(' + k + ')'))),
                    (c[j] = k);
              ...
              (e.prototype = {
                userCertify: function () {
                  ...
                  var e = 'web-html5-' + a,
                    f = b.getBrowserInfo(),
                    g =
                      'https://drm.media.baidubce.com/v1/playerAuth?ak=' +
                      d +
                      '&player=' +
                      e +
                      '&platform=' +
            ...
            return function (e, f) {
              ...
              function h(a) {
                ...
                if (b && 'textdata' === b.type) {
                  ...
                  var e, g;
                  b.useDTS
                    ? (c.source || (c.source = b.source || 'mpegts'), (e = b.begin), (g = b.begin + '_' + b.text))
                    : ((e = a.position || f.get('position')), (g = Math.round(10 * e) + '_' + b.text));
                  var h = w[g];
              ...
              function k(a) {
                ...
                for (i = 0; i < k.length; i++)
                  (b = k[i]),
                    ...
                    (!l && e && !s && o) ||
                      ('captions' !== (c = b.kind.toLowerCase()) && 'subtitles' !== c) ||
                      (b.file ? (m(b), n(b)) : b.data && m(b));
              ...
              function p() {
                for (var a = [{id: 'off', label: 'Off'}], b = 0; b < u.length; b++)
                  a.push({id: u[b].id, label: u[b].label || 'Unknown CC'});
                return a;
              }
              function q() {
                var a = 0,
    ...
    function (a, b, c) {
      ...
      (d = [
        ...
        void 0 !==
          (e = function (a, b, c, d, e, g, h, i, j, k, l, m, n, o, p, q, r, s) {
            function t(a) {
              return function () {
            ...
            return (
              (v.prototype = {
                ...
                setup: function (g, n) {
                  ...
                  function v() {
                    fa.trigger(q.JWPLAYER_READY, {setupTime: 0}),
                      fa.trigger(q.JWPLAYER_PLAYLIST_LOADED, {playlist: ca.get('playlist')}),
                      fa.trigger(q.JWPLAYER_PLAYLIST_ITEM, {index: ca.get('item'), item: ca.get('playlistItem')}),
                      ...
                      ca.get('autostart') &&
                        (!k.isPoorIE() && ca.get('imageAdvs') && ca.get('imageAdvs').start
                          ? Z.beginStartAdv()
                          : A({reason: 'autostart'})),
                      w();
                  }
                  ...
                  function x(a) {
                    switch (
                      (ca.get('state') === p.ERROR && ca.set('state', p.IDLE),
                      B(!0),
                    ...
                    if ((a && ca.set('playReason', a.reason), ca.get('state') !== p.ERROR)) {
                      ...
                      if ((ca.get('state') === p.COMPLETE && (B(!0), H(0)), !da)) {
                        ...
                        if (
                          ...
                          return (ba = !1), void (aa = null);
                      }
                      if (D()) {
                        if (0 === ca.get('playlist').length) return !1;
                        !k.isPoorIE() && ca.get('imageAdvs') && ca.get('imageAdvs').start
                          ? Z.beginStartAdv()
                          : (b = k.tryCatch(function () {
                              ca.loadVideo();
                            }));
                      } else
                        ca.get('state') === p.PAUSED &&
                          (b = k.tryCatch(function () {
                            ca.playVideo();
                          }));
                  ...
                  function K() {
                    if (D()) {
                      ...
                      aa = K;
                      return ca.get('item') === ca.get('playlist').length - 1
                        ? void (ca.get('repeat')
                            ? J({reason: 'repeat'})
                            : (ca.set('state', p.COMPLETE), fa.trigger(q.JWPLAYER_PLAYLIST_COMPLETE, {})))
                        : void J({reason: 'playlist'});
                    }
                  }
                  function L(a) {
                  ...
                  function T(a) {
                    (a = parseInt(a, 10) || 0),
                      ...
                      fa.trigger(q.JWPLAYER_CAPTIONS_CHANGED, {tracks: V(), track: a});
                  }
                  function U() {
                  ...
                  function X() {
                    ...
                    return a instanceof k.Error
                      ? void k.log('Error calling _attachMedia', a)
                      : void ('function' == typeof aa && aa());
                  }
                  function Y(a) {
                  ...
                  ca.setup(ia, ha),
                    ...
                    (this.addButton = function (a, b, d, e, f) {
                      var g = {img: a, tooltip: b, callback: d, id: e, btnClass: f},
                        h = ca.get('dock');
                    ...
                    (this.createInstream = function () {
                      return (
                        this.instreamDestroy(), (this._instreamAdapter = new b(this, ca, Z)), this._instreamAdapter
                      );
                    }),
      ...
      (d = [c(84), c(83), c(4), c(7), c(2), c(3), c(1)]),
        void 0 !==
          (e = function (a, b, c, d, e, f, g) {
            ...
            var i = {skipoffset: null, tag: null},
              j = function (a, b, f) {
                function j(a, b) {
                ...
                function l(a) {
                  ...
                  if ((u.tag && (d.tag = u.tag), m && t + 1 < m.length)) {
                    ...
                    a.type === c.JWPLAYER_MEDIA_COMPLETE &&
                      (this.trigger(c.JWPLAYER_MEDIA_COMPLETE, d), this.trigger(c.JWPLAYER_PLAYLIST_COMPLETE, {})),
                      this.destroy();
                }
                var m,
                  n,
                  ...
                  v = g.bind(function (a) {
                    (a = a || {}),
                      ...
                      s &&
                        s._adModel &&
                        (s._adModel.get('state') === d.PAUSED ? a.hasControls && s.instreamPlay() : s.instreamPause());
                  }, this),
                  w = g.bind(function () {
                    s &&
                      s._adModel &&
                ...
                (this.type = 'instream'),
                  ...
                  (this.loadItem = function (a, d) {
                    ...
                    g.isArray(a) && ((m = a), (n = d), (a = m[t]), n && (d = n[t])),
                      this.trigger(c.JWPLAYER_PLAYLIST_ITEM, {index: t, item: a}),
                      (u = g.extend({}, i, d)),
                      s.load(a),
              ...
              return (
                ...
                (this.instreamDestroy = function () {
                  m &&
                    (m.off(),
                    this.off(),
                    n && (n.detachMedia(), n.off(), m.getVideo() && n.destroy()),
                    (m = null),
    ...
    function (a, b, c) {
      ...
      (d = [c(20), c(36), c(57), c(43), c(21), c(1), c(2), c(4), c(8), c(17)]),
        void 0 !==
          (e = function (a, b, d, e, f, g, h, i, j, k) {
            function l() {
              return {
            ...
            function p(a, b) {
              ...
              h.isFlvjsSupported() && (h.isFlv(d[0].file) || (d[0].sources && h.isFlv(d[0].sources[0].file)))
                ? c.e(1, function (require) {
                    c(51), a();
                  })
                : a();
            }
            function q(a) {
              return (
                h.isFlvjsSupported() &&
                !h.isMobile() &&
                (h.isHls(a[0].file) || (a[0].sources && h.isHls(a[0].sources[0].file)))
              );
            }
            function r(a, b) {
              if (
                q(b.get('playlist')) &&
                window.videojs &&
                !window.videojs.getPlugin('qualityLevels') &&
                !b.get('isLive')
              ) {
            ...
            function A(a) {
              var b = '',
                c = '';
              return (
                h.flashVersion() || h.isMobile()
                  ? h.flashVersion() && h.flashVersion() < 11.2
                    ? ((b =
                        'Flash Player版本必须大于11.2, <a href="https://get.adobe.com/cn/flashplayer/" target="_blank">更新Flash Player</a>'),
                      (c = '102'))
                    : h.isMobile() &&
                      (h.isRtmp(a[0].file) || h.isFlv(a[0].file)) &&
                      ((b = '手机上不能播放rtmp或flv格式的视频'), (c = '111'))
                  : ((b =
                      '未检测到Flash Player，请到<a href="https://get.adobe.com/cn/flashplayer/" target="_blank">安装</a>'),
                    (c = '101')),
                {errorMessage: b, errorCode: c}
              );
            }
            function B(a, b) {
      ...
      (d = [c(19), c(8), c(2)]),
        void 0 !==
          (e = function (a, b, c) {
            return function (d, e) {
              for (
                var f = [], g = [], h = b.xmlAttribute, i = 'default', j = 'label', k = 'file', l = 0;
                ...
                if ('jwplayer' === m.prefix) {
                  var n = a.localName(m);
                  'source' === n
                    ? (delete e.sources, f.push({file: h(m, k), default: h(m, i), label: h(m, j), type: h(m, 'type')}))
                    : 'track' === n
                    ? (delete e.tracks, g.push({file: h(m, k), default: h(m, i), kind: h(m, 'kind'), label: h(m, j)}))
                    : ((e[n] = c.serialize(a.textContent(m))), 'file' === n && e.sources && delete e.sources);
                }
                e[k] || (e[k] = e.link);
              }
              if (f.length)
                for (e.sources = [], l = 0; l < f.length; l++)
                  f[l].file.length > 0 &&
                    ((f[l][i] = 'true' === f[l][i]), f[l].label.length || delete f[l].label, e.sources.push(f[l]));
              if (g.length)
                for (e.tracks = [], l = 0; l < g.length; l++)
                  g[l].file.length > 0 &&
                    ((g[l][i] = 'true' === g[l][i]),
                  ...
                  switch (f(j).toLowerCase()) {
                    case 'content':
                      if ((e(j, 'duration') && (b.duration = c.seconds(e(j, 'duration'))), e(j, 'url'))) {
                        b.sources || (b.sources = []);
                        var n = {file: e(j, 'url'), type: e(j, 'type'), width: e(j, 'width'), label: e(j, 'label')},
                          o = d(j);
                  ...
                  (n = e.after(r, k)),
                    e.each(j, function (e, g) {
                      ...
                      l !== f.loaderstatus.LOADING &&
                        ...
                        (j && !b.versionCheck(k) && o.trigger(c.ERROR, {message: 'Incompatible player version'}), n());
                    });
                }
              }
              function m(a) {
        ...
        void 0 !==
          (e = function (a, b) {
            ...
            function e(a) {
              ...
              for (var c in a)
                'object' === f(a[c])
                  ? b.push(c + '=' + encodeURIComponent(JSON.stringify(a[c])))
                  : b.push(c + '=' + a[c]);
              return b.join('&');
            }
            function g(a) {
            ...
            return function (a, b) {
              ...
              a.on('meta', function (a) {
                ...
                l.cdn_ip &&
                  ((f = {action: '/user/web/cdn', url: h.get('file') || h.getCurrentItem().file, cdn: l.cdn_ip}), g(f));
              }),
                    ...
                    : (e &&
                      ...
                      void (
                        ...
                        ((k = setInterval(function () {
                          (f = {action: '/user/web/count', session: r, url: h.get('file') || h.getCurrentItem().file}),
                            g(f);
                        }, 6e4)),
                        (f = {action: '/user/web/count', session: r, url: h.get('file') || h.getCurrentItem().file}),
                        g(f))
          ...
          (e = function (a, b, c, d, e, f, g, h, i) {
            ...
            function l(l, u) {
                ...
                o(sa),
                  ...
                  ua &&
                    (oa.state === f.STALLED
                      ...
                      : oa.state === f.PLAYING && (sa = setTimeout(X, p)),
                    (Fa.duration === 1 / 0 && 0 === Fa.currentTime) ||
                      (E(D()),
                      C(Fa.currentTime),
                      B(Y(), la, ka),
                      oa.state === f.PLAYING && oa.trigger(e.JWPLAYER_MEDIA_TIME, {position: la, duration: ka})));
              }
              function B(a, b, c) {
                (a === ta && c === ka) ||
                  ((ta = a), oa.trigger(e.JWPLAYER_MEDIA_BUFFER, {bufferPercent: 100 * a, position: b, duration: c}));
              }
              function C(a) {
                ka < 0 && (a = -(U() - a)), (la = a);
              }
              ...
              function L() {
                Fa.paused ||
                  Fa.ended ||
                  (oa.state !== f.LOADING && oa.state !== f.ERROR && (oa.seeking || oa.setState(f.STALLED)));
              }
              function M() {
                ua &&
                  (m.hls && m.hls.reconnecttime
                    ? setTimeout(function () {
                        return oa.load(n);
                      }, 1e3 * m.hls.reconnecttime)
                    : t < m.retryCount && n
                    ? (t++,
                      setTimeout(function () {
                        return oa.load(n);
                      }, 3e3))
                    : (b.log('Error playing media: %o %s', Fa.error, Fa.src),
                      oa.trigger(e.JWPLAYER_MEDIA_ERROR, {message: '加载失败: 不能播放当前文件', code: '111'})));
              }
              function N(a) {
                var c;
                return (
              ...
              function R(a) {
                ...
                (b.src = a.file),
                  Fa.src !== b.src &&
                    (Fa.setAttribute('jw-loaded', 'none'), Ga.src({src: a.file, type: 'application/x-mpegURL'}));
              }
              function S() {
                Fa &&
                  (oa.disableTextTrack(),
              ...
              function ea(a) {
                if (((za = null), a)) {
                  ...
                  oa.addTracksListener(a, 'change', aa),
                    za && oa.trigger('audioTracks', {currentTrack: Aa, tracks: za});
                }
              }
              function fa(a) {
                Fa &&
                  ...
                  za &&
                  a > -1 &&
                  a < Fa.audioTracks.length &&
                  a !== Aa &&
                  ((Fa.audioTracks[Aa].enabled = !1),
                  (Aa = a),
                  (Fa.audioTracks[Aa].enabled = !0),
                  oa.trigger('audioTrackChanged', {currentTrack: Aa, tracks: za}));
              }
              function ga() {
                return za || [];
              }
              ...
              (this.isSDK = wa),
                ...
                (this.init = function (a, b) {
                  ua &&
                    ...
                    (Ca = this.itemTracks),
                    b.minBufferLength > 0 &&
                      ((videojs.Hls.MAX_GOAL_BUFFER_LENGTH = b.minBufferLength),
                ...
                (this.play = function () {
                  return oa.seeking
                    ? (oa.setState(f.LOADING), void oa.once(e.JWPLAYER_MEDIA_SEEKED, oa.play))
                    : void Ga.play();
                }),
                (this.pause = function () {
                ...
                (this.seek = function (a) {
                  if (ua)
                    if (
                      (a < 0 && (a += T() + U()),
                      0 === ra && this.trigger(e.JWPLAYER_MEDIA_SEEK, {position: Fa.currentTime, offset: a}),
                      qa || (qa = !!U()),
                      qa)
                    ) {
                      ra = 0;
                ...
                (this.setContainer = function (a) {
                  ...
                  (ja = a),
                    ...
                    Ga.tech({IWillNotUseThisInPlugins: !0}).on(e.JWPLAYER_ALIVE, function () {
                ...
                (this.setVisibility = function (b) {
                  (b = !!b),
                    b ? a.style(ja, {visibility: 'visible', opacity: 1}) : a.style(ja, {visibility: '', opacity: 0});
                }),
                (this.resize = function (b, c, d) {
      ...
      (d = [c(2), c(3), c(1)]),
        void 0 !==
          (e = function (a, b, c) {
            ...
            function e(e, g, j, k, l, m) {
              ...
              if (((k = k || 'opaque'), a.isMSIE() || a.isPoorIE())) {
                ...
                g.appendChild(o),
                  (o.outerHTML =
                    ...
                    (m ? '<param name="flashVars" value="enableControlbar=true">' : '') +
                    '</object>');
              ...
              return (
                ...
                (n.triggerFlash = function (b) {
                  ...
                  return j instanceof a.Error && (console.error(b, j), 'setup' === b)
                    ? ((j.name = 'Failed to setup flash'), j)
                    : d;
                }),
                (n.__commandQueue = []),
                n
            ...
            function h(b, c, d) {
              ((a.isPoorIE() && b && b.childNodes) || (window.HTMLElement && b instanceof window.HTMLElement)) &&
                delete d[c];
            }
            var i = '#000000';
      ...
      (d = []),
        void 0 !==
          (e = function () {
            var a = {};
            return (
              (a.getElementsByClassName = function (a, b, c) {
                ...
                Function.prototype.bind ||
                  (Function.prototype.bind = function (a) {
                    ...
                    var b = Array.prototype.slice.call(arguments, 1),
                      ...
                      e = function () {
                        return c.apply(
                          this instanceof d && a ? this : a || window,
              ...
              c.extend(f.prototype, {
                ...
                loadAdv: function (a) {
                  ...
                  if (d && d[a] && d[a].image) {
                    ...
                    if (
                      (c.isString(f)
                        ? ((f = encodeURI(f)), (i.backgroundImage = 'url("' + f + '")'))
                        : (i.backgroundImage = ''),
                      'end' === a && (i['z-index'] = 0),
                      'pause' === a)
                    ) {
                ...
                element: function () {
                  var a = this.api.getContainer();
                  return b.getElementsByClassName('jw-adv', a).length > 0
                    ? b.getElementsByClassName('jw-adv', a)[0]
                    : this.el;
                },
                isHidden: function () {
                  return this.isHide;
          ...
          (e = function (a, b, c, d) {
            ...
            return function (g) {
              function h(b) {
                ...
                b
                  ? ((t.innerHTML = b), (s.className = c + ' jw-captions-window-active'))
                  : ((s.className = c), a.empty(t));
              }
              function i(a) {
                (q = a), k(o, q);
              }
              ...
              function m(a, c, d) {
                if (
                  (b.css('#' + a + ' .jw-video::-webkit-media-text-track-display', c, a),
                ...
                (this.setup = function (a, c) {
                  if (
                    ...
                    i && (l.backgroundColor = b.hexToRgba(u.windowColor, i)),
                      n(j, o, h),
                      u.back
                        ? (o.backgroundColor = b.hexToRgba(k, u.backgroundOpacity))
                        : null === j && n('uniform', o),
                      e(s, l),
                      e(t, o),
                      m(a, l, o);
        ...
        void 0 !==
          (e = function (a, b, c, d) {
            return a.extend({
              ...
              setup: function (a, e) {
                this.iconUI ||
                  ((this.iconUI = new d(this.el, {useHover: !0, directSelect: !0})),
          ...
          (e = function (a, b, c, d, e) {
            return a.extend({
              ...
              selectItem: function (a) {
                ...
                this.isPlayrateMenu() &&
                  this.list[a] &&
                  (b.getElementsByClassName('jw-playrate-label', this.el)[0].innerHTML = this.list[a].label);
              },
              reset: function () {
                b.addClass(this.el, 'jw-off'),
                  this.iconUI.off(),
          ...
          (e = function (a, b, c, d, e) {
            return c.extend({
              setup: function (c, e) {
                if (
                  (this.iconUI ||
                    ((this.iconUI = new d(this.el, {useHover: !0})),
                    (this.toggleOpenStateListener = this.toggleOpenState.bind(this)),
                    (this.openTooltipListener = this.openTooltip.bind(this)),
                    (this.closeTooltipListener = this.closeTooltip.bind(this)),
          ...
          (e = function (a, b, c) {
            ...
            return {
              loadThumbnails: function (a) {
                a &&
                  ((this.vttPath = a.split('?')[0].split('/').slice(0, -1).join('/')),
                  (this.individualImage = null),
                  b.ajax(a, this.thumbnailsLoaded.bind(this), this.thumbnailsFailed.bind(this), {plainText: !0}));
              },
              ...
              chooseThumbnail: function (b) {
                if (
                  !a.find(this.thumbnails, function (a) {
                ...
                if (c.indexOf('#xywh') > 0)
                  ...
                  c &&
                    (this.individualImage
                      ? ((d.width = this.individualImage.width), (d.height = this.individualImage.height))
              ...
              i = d.extend({
                ...
                performSeek: function () {
                  ...
                  0 === d
                    ? this._api.play()
                    : 'DVR' === e
                    ? ((a = ((100 - c) / 100) * d), this._api.seek(a))
                    : this._model.attributes.controlbar.canDrag &&
                      ((a = (c / 100) * d), this._api.seek(Math.min(a, d - 0.25)));
                },
            ...
            return a.extend({
              constructor: function (e, f) {
                (this._model = e),
                  ...
                  new c(this.el, {useHover: !0, directSelect: !0})
              ...
              b.extend(p.prototype, c, {
                ...
                build: function () {
                  ...
                  !1 !== this._model.get('visualplaylist') && (a = new i('jw-icon-playlist')),
                    this._isMobile ||
                      ((e = l('jw-icon-volume', this._api.setMute)),
                  ...
                  this._model.get('controlbar').barLogo && this.elements.barLogo.show(),
                    ...
                    this.elements.hd.on(
                      ...
                      function () {
                        this._model
                          .getVideo()
                          .setCurrentQuality(0 === this._model.getVideo().getCurrentQuality() ? 1 : 0);
                      },
                      this
                    ),
                    this.elements.cc.on(
                    ...
                    new e(this.elements.duration).on(
                      'click tap',
                      function () {
                ...
                onMediaModel: function (c, d) {
                  d.on(
                    ...
                    d.on(
                      ...
                      function (b, c) {
                        'complete' === c &&
                          (this.elements.drawer.closeTooltip(), a.removeClass(this.el, 'jw-drawer-expanded'));
                      },
                      this
                    ),
                    d.on(
                ...
                onProvider: function (a, b) {
                  /(html5|videojs)/.test(b.name) && a.get('playRate') && !this._isMobile
                    ? this.elements.playRate.setup(a.get('playRateConfig'), 0)
                    : this.elements.playRate.hide();
                },
                ...
                renderVolume: function (b, c, d) {
                  ...
                  d || (d = c),
                    ...
                    this.elements.volumetooltip &&
                      this.elements.volumetooltip.valuetip &&
                      ((e = this.elements.volumetooltip.valuetip),
                      b
                        ? (e.innerHTML = '0%')
                        : 100 === c &&
                          c > d &&
                          this._model.get('provider') &&
                          /^flash/.test(this._model.get('provider').name)
                        ? (e.innerHTML = '100%(按↑可以继续增大音量)')
                        : (e.innerHTML = c + '%'));
                },
                ...
                getVisibleBounds: function () {
                  var b,
                    c = this.el;
                  return 'table' === (getComputedStyle ? getComputedStyle(c) : c.currentStyle).display
                    ? a.bounds(c)
    ...
    function (a, b, c) {
      ...
      (d = [c(9), c(2), c(4), c(1), c(3), c(171)]),
        void 0 !==
          (e = function (a, b, c, d, e, f) {
            var g = b.style,
              h = {linktarget: '_blank', margin: 8, hide: !1, position: 'top-right'};
            return function (i) {
              var j,
                k,
                l = new Image(),
                ...
                (this.setup = function (e) {
                  if (
                    ...
                    k.hide && b.addClass(j, 'jw-hide'),
                      ...
                      'top-right' === k.position &&
                        (i.on('change:dock', this.topRight, this),
                    ...
                    new a(j).on(
                      ...
                      function (a) {
                        b.exists(a) && a.stopPropagation && a.stopPropagation(),
                          this.trigger(c.JWPLAYER_LOGO_CLICK, {link: k.link, linktarget: k.linktarget});
                      },
                      this
                    ),
                      e.appendChild(j);
              ...
              b.extend(e.prototype, {
                init: function () {
                  ...
                  b && (this.element.innerHTML = b),
                    d && c.style(this.element, {color: d}),
                    e && c.style(this.element, {fontSize: e, lineHeight: e + 8}),
                    this.reset();
                },
                start: function () {
                  return (
                    !a.isMSIE(9) &&
                    void c.style(this.element, {animationPlayState: 'running', opacity: 1, display: 'block'})
                  );
                },
                stop: function () {
                ...
                pause: function () {
                  'running' === this.element.style.animationPlayState &&
                    c.style(this.element, {animationPlayState: 'paused'}),
                    c.style(this.element, {opacity: 0});
                },
                reset: function (b, d) {
      ...
      (d = [c(1), c(2)]),
        void 0 !==
          (e = function (a, b) {
            ...
            function d(a, c) {
              return (a.get('autostart') && !b.isMobile()) || a.get('item') > 0
                ? (this.setImage(null),
                  ...
                  a.isString(c) && ((e = 'url("' + c + '")'), (d = this.image = new Image()), (d.src = c)),
                    b.isPoorIE()
                      ? (this.el.style.filter =
                          'progid:DXImageTransform.Microsoft.AlphaImageLoader(src="' + c + '",sizingMethod="scale"')
                      : b.style(this.el, {backgroundImage: e});
                },
            ...
            return (
              c.extend(f.prototype, {
                buildArray: function () {
                  ...
                  g && c.isArray(g) && g.length > 0
                    ...
                    : f.items.push({
                        ...
                        link:
                          'https://bce.baidu.com/doc/MCT/Web-SDK.html#.E6.92.AD.E6.94.BE.E5.99.A8.20Web.20SDK.20.E7.AE.80.E4.BB.8B'
                      });
                ...
                getOffset: function (b) {
                  ...
                  return (
                    (d = d <= this.playerElement.clientWidth ? d : this.playerElement.clientWidth),
                ...
                hideMenu: function () {
                  this.mouseOverContext ||
                    (a.removeClass(this.playerElement, 'jw-flag-rightclick-open'), a.removeClass(this.el, 'jw-open'));
                },
                lazySetup: function () {
                  this.el ||
                    ...
                    (this.elementUI = new d(this.el, {useHover: !0})
                      .on(
                        'over',
                        function () {
          ...
          (e = function (a, b) {
            ...
            return (
              a.extend(c.prototype, {
                ...
                update: function (a) {
                  var c = {paddingLeft: 0, paddingRight: 0},
                    d = a.get('controls'),
                    e = a.get('dock'),
                    f = a.get('logo');
                  if (f) {
                    ...
                    'top-left' === f.position
                      ? (c.paddingLeft = h)
                      : 'top-right' === f.position && (c.paddingRight = h);
                  }
                  if (d && e && e.length) {
                    var i = 56 * e.length;
          ...
          (e = function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r) {
            ...
            return function (w, x) {
              ...
              function z(b) {
                ...
                '-' === b
                  ? (c = d > 100 ? -50 : -10)
                  : ((c = d >= 100 ? 50 : 10), d < 100 && d + c > 100 && (c = 100 - d));
                var e = x.getVideo(),
                  ...
                  document.body.contains(la)
                    ? d &&
                      ...
                      ((d === oa && e === pa) ||
                        ...
                        Pa.trigger(b.JWPLAYER_RESIZE, {width: d, height: e})))
              ...
              function K(b) {
                b &&
                  !u &&
                  (a.addEventListener(b.element(), 'mousemove', N, !1),
                  a.addEventListener(b.element(), 'mouseout', O, !1));
              }
              function L() {
                (x.get('state') !== e.IDLE && x.get('state') !== e.COMPLETE && x.get('state') !== e.PAUSED) ||
                  !x.get('controls') ||
              ...
              function M(a) {
                a.link
                  ? (w.pause(!0), w.setFullscreen(!1), window.open(a.link, a.linktarget))
                  : x.get('controls') && w.play({reason: 'interaction'});
              }
              function N() {
                clearTimeout(Ga);
              }
              ...
              function Q(b, c) {
                c
                  ? (Ca && Ca.destroy(), a.addClass(la, 'jw-flag-flash-blocked'))
                  : (Ca && Ca.setup(x, la, la), a.removeClass(la, 'jw-flag-flash-blocked'));
              }
              function R() {
              ...
              function S() {
                ...
                a.addEventListener(c, 'mousemove', ca),
                  (va = new g(x, na, {useHover: !0})),
                  va.on('click', function () {
                    P({type: b.JWPLAYER_DISPLAY_CLICK}),
                      x.get('controls') &&
                        !x.get('flashUI') &&
                        x.get('allowClickToDisplay') &&
                        w.play({reason: 'interaction'});
                  }),
                  va.on('tap', function () {
                ...
                var l = x.get('height');
                u && ('string' == typeof l || l >= 1.5 * Ia)
                  ? a.addClass(la, 'jw-flag-touch')
                  : ((Ca = new o()), Ca.setup(x, la, la)),
                  (ra = new k(w, x)),
              ...
              function T(b) {
                return b.get('state') === e.PAUSED
                  ? void b.once('change:state', T)
                  : void (!1 === b.get('scrubbing') && a.removeClass(la, 'jw-flag-dragging'));
              }
              function U(b, c) {
              ...
              function X(a) {
                return (
                  !x.get('aspectratio') &&
                  !(q.isString(a) && a.indexOf('%') > -1) &&
                  Y(q.isNumber(a) ? a : x.get('containerHeight'))
                );
              }
              function Y(a) {
              ...
              function Z(b, c) {
                ...
                if (d) {
                  d.resize(b, c, x.get('stretching')) && (clearTimeout(La), (La = setTimeout(Z, 250))),
                    ...
                    x.get('state') === e.PAUSED &&
                      x.get('imageAdvs') &&
                      x.get('imageAdvs').pause &&
                      ta &&
                      !ta.isHidden() &&
                      ta.resizePauseAdv(b, c);
                }
              }
              function $() {
                if (Na) {
              ...
              function aa(b, c) {
                c
                  ? (a.addClass(b, 'jw-flag-fullscreen'), s(document.body, {'overflow-y': 'hidden'}), ca())
                  : (a.removeClass(b, 'jw-flag-fullscreen'), s(document.body, {'overflow-y': ''})),
                  Z();
              }
              function ba() {
              ...
              function ha(a, b) {
                return b
                  ? void (b.name ? za.updateText(b.name, b.message) : za.updateText(b.message, ''))
                  : void za.playlistItem(a, a.get('playlistItem'));
              }
              function ia() {
                var a = x.getVideo();
                return !!a && a.isCaster;
              ...
              (this.model = x),
                (this.api = w),
                (la = a.createElement(r({id: x.get('id')}))),
              ...
              s(la, {
                ...
                (Ea =
                  ...
                  la.webkitRequestFullscreen ||
                  la.webkitRequestFullScreen ||
                  la.mozRequestFullScreen ||
                  la.msRequestFullscreen),
                (Fa =
                ...
                (this.setup = function () {
                  this.handleColorOverrides(),
                    !0 === x.get('skin-loading') &&
                      (a.addClass(la, 'jw-flag-skin-loading'),
                  ...
                  if (((za = new p(x)), za.setup(d), a.isPoorIE()))
                    a.style(a.getElementsByClassName('jw-marquee', la)[0], {display: 'none'});
                  else if (
                    ((ta = new m(x, w)), x.get('imageAdvs') && la.appendChild(ta.element()), x.get('marquee').show)
                  ) {
              ...
              var Sa = function (b, c) {
                ...
                Ta = function (b, c) {
                  var d = x.getVideo();
                  Na
                    ? (c ? Ea.apply(la) : Fa.apply(document), aa(la, c))
                    : a.isIE()
                    ? aa(la, c)
                    : (qa && qa.getVideo() && qa.getVideo().setFullscreen(c), d.setFullscreen(c)),
              ...
              (this.resize = function (a, b) {
                ...
                (this.destroyInstream = function () {
                  if (
                    ((Ja = !1),
                    qa && (qa.off(null, null, this), (qa = null)),
                    this.setAltText(''),
                ...
                (this.getSafeRegion = function (b) {
                  var c = {x: 0, y: 0, width: x.get('containerWidth') || 0, height: x.get('containerHeight') || 0},
                    d = x.get('dock');
                  return (
                    d && d.length && x.get('controls') && ((c.y = xa.element().clientHeight), (c.height -= c.y)),
                    (b = b || !a.exists(b)),
        ...
        a.registerHelper('each', function (a, b) {
          function c(b, c, f) {
            j && ((j.key = b), (j.index = c), (j.first = 0 === c), (j.last = !!f), k && (j.contextPath = k + b)),
              (i += e(a[b], {data: j, blockParams: d.blockParams([a[b], b], [k + b, null])}));
          }
          ...
          var e = b.fn,
            ...
            k = void 0;
          if (
            (b.data && b.ids && (k = d.appendContextPath(b.data.contextPath, b.ids[0]) + '.'),
            d.isFunction(a) && (a = a.call(this)),
            b.data && (j = d.createFrame(b.data)),
            a && 'object' == typeof a)
          )
            if (d.isArray(a)) for (var l = a.length; h < l; h++) h in a && c(h, h, h === a.length - 1);
            else {
              var m = void 0;
      ...
      a.exports = (d['default'] || d).template({
        1: function (a, b, c, d, e) {
          ...
          return (
            ...
            (null !=
            (f = c['if'].call(h, null != b ? b.btnClass : b, {
              name: 'if',
              hash: {},
              fn: a.program(2, e, 0),
              inverse: a.noop,
            ...
            (null !=
            (f = c['if'].call(h, null != b ? b.tooltip : b, {
              name: 'if',
              hash: {},
              fn: a.program(6, e, 0),
              inverse: a.noop,
        ...
        2: function (a, b, c, d, e) {
          ...
          return (
            ' ' +
            a.escapeExpression(
              ((f = null != (f = c.btnClass || (null != b ? b.btnClass : b)) ? f : c.helperMissing),
              'function' == typeof f ? f.call(null != b ? b : {}, {name: 'btnClass', hash: {}, data: e}) : f)
            )
          );
        },
        4: function (a, b, c, d, e) {
          ...
          return (
            ...
            a.escapeExpression(
              ((f = null != (f = c.img || (null != b ? b.img : b)) ? f : c.helperMissing),
              'function' == typeof f ? f.call(null != b ? b : {}, {name: 'img', hash: {}, data: e}) : f)
            ) +
            '")\''
          );
        },
        6: function (a, b, c, d, e) {
          ...
          return (
            ...
            a.escapeExpression(
              ((f = null != (f = c.tooltip || (null != b ? b.tooltip : b)) ? f : c.helperMissing),
              'function' == typeof f ? f.call(null != b ? b : {}, {name: 'tooltip', hash: {}, data: e}) : f)
            ) +
            '</span>\n        </div>\n'
          );
        },
      ...
      a.exports = (d['default'] || d).template({
        ...
        main: function (a, b, c, d, e) {
          ...
          return (
            ...
            '"class="jw-skin-' +
            k(
              ((g = null != (g = c.skin || (null != b ? b.skin : b)) ? g : i),
              typeof g === j ? g.call(h, {name: 'skin', hash: {}, data: e}) : g)
            ) +
            ' jw-error jw-reset">\n    <div class="jw-title jw-reset">\n        <div class="jw-title-primary jw-reset">' +
            (null !=
            ((g = null != (g = c.title || (null != b ? b.title : b)) ? g : i),
            (f = typeof g === j ? g.call(h, {name: 'title', hash: {}, data: e}) : g))
              ? f
              : '') +
            '</div>\n        <div class="jw-title-secondary jw-reset">' +
            k(
              ((g = null != (g = c.body || (null != b ? b.body : b)) ? g : i),
              typeof g === j ? g.call(h, {name: 'body', hash: {}, data: e}) : g)
            ) +
      ...
      a.exports = (d['default'] || d).template({
        1: function (a, b, c, d, e) {
          ...
          return (
            'src="' +
            a.escapeExpression(
              ((f = null != (f = c.file || (null != b ? b.file : b)) ? f : c.helperMissing),
              'function' == typeof f ? f.call(null != b ? b : {}, {name: 'file', hash: {}, data: e}) : f)
            ) +
            '"'
          );
        },
        ...
        main: function (a, b, c, d, e) {
          ...
          return (
            ...
            (null !=
            (f = c['if'].call(null != b ? b : {}, null != b ? b.file : b, {
              name: 'if',
              hash: {},
              fn: a.program(1, e, 0),
              inverse: a.noop,
      ...
      a.exports = (d['default'] || d).template({
        1: function (a, b, c, d, e) {
          ...
          return (
            ...
            g(
              ((f = null != (f = c.index || (e && e.index)) ? f : c.helperMissing),
              'function' == typeof f ? f.call(null != b ? b : {}, {name: 'index', hash: {}, data: e}) : f)
            ) +
            " jw-reset'>" +
            g(a.lambda(null != b ? b.label : b, b)) +
            '</li>\n'
          );
        },
        compiler: [7, '>= 4.0.0'],
      ...
      a.exports = (d['default'] || d).template({
        ...
        main: function (a, b, c, d, e) {
          ...
          return (
            '<div id="' +
            a.escapeExpression(
              ((f = null != (f = c.id || (null != b ? b.id : b)) ? f : c.helperMissing),
              'function' == typeof f ? f.call(null != b ? b : {}, {name: 'id', hash: {}, data: e}) : f)
            ) +
    ...
    function (a, b, c) {
      ...
      a.exports = (d['default'] || d).template({
        1: function (a, b, c, d, e) {
          var f;
          return null !=
            (f = c['if'].call(null != b ? b : {}, null != b ? b.active : b, {
              name: 'if',
              hash: {},
              fn: a.program(2, e, 0),
        ...
        2: function (a, b, c, d, e) {
          ...
          return (
            ...
            ' jw-reset\'>\n                    <span class="jw-label jw-reset"><span class="jw-icon jw-icon-play jw-reset"></span></span>\n                    <span class="jw-name jw-reset" title="' +
            g(h(null != b ? b.title : b, b)) +
            '">' +
            g(h(null != b ? b.title : b, b)) +
            '</span>\n                </li>\n'
          );
      ...
      a.exports = (d['default'] || d).template({
        1: function (a, b, c, d, e) {
          ...
          return (
            '        <li class="jw-reset' +
            (null !=
            (f = c['if'].call(h, null != b ? b.featured : b, {
              name: 'if',
              hash: {},
              fn: a.program(2, e, 0),
              inverse: a.noop,
            ...
            '">\n            <a href="' +
            k(
              ((g = null != (g = c.link || (null != b ? b.link : b)) ? g : i),
              typeof g === j ? g.call(h, {name: 'link', hash: {}, data: e}) : g)
            ) +
            '" class="jw-reset" target="_blank">\n' +
            (null !=
            (f = c['if'].call(h, null != b ? b.showLogo : b, {
              name: 'if',
              hash: {},
              fn: a.program(4, e, 0),
              inverse: a.noop,
            ...
            k(
              ((g = null != (g = c.title || (null != b ? b.title : b)) ? g : i),
              typeof g === j ? g.call(h, {name: 'title', hash: {}, data: e}) : g)
            ) +
            '\n            </a>\n        </li>\n'
          );
        },
        ...
        main: function (a, b, c, d, e) {
          ...
          return (
            ...
            (null !=
            (f = c.each.call(null != b ? b : {}, null != b ? b.items : b, {
              name: 'each',
              hash: {},
              fn: a.program(1, e, 0),
              inverse: a.noop,
      ...
      a.exports = (d['default'] || d).template({
        ...
        main: function (a, b, c, d, e) {
          ...
          return (
            '<div class="' +
            j(
              ((f = null != (f = c.className || (null != b ? b.className : b)) ? f : h),
              typeof f === i ? f.call(g, {name: 'className', hash: {}, data: e}) : f)
            ) +
            ' ' +
            j(
              ((f = null != (f = c.orientation || (null != b ? b.orientation : b)) ? f : h),
              typeof f === i ? f.call(g, {name: 'orientation', hash: {}, data: e}) : f)
            ) +
