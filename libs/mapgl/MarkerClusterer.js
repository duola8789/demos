...
(function () {
  ...
  var MarkerClusterer =
     ...
     */
    (BMapLib.MarkerClusterer = function (map, options, isRich) {
      if (!map) {
        return;
      }
      this._map = map;
  ...
  Cluster.prototype.isMarkerInClusterBounds = function (marker) {
    ...
    const b = this._gridBounds.containsPoint(a);
    console.log(b);
    return this._gridBounds.containsPoint(a);
  };
