...
<html>
    <body>
        <div style="width: 100%; height: 99%; background: #fff; padding: 1px">
            <div style="width: 700px;max-width: 80%;margin: 40px auto;background: #f6f6f6;padding: 32px 24px 24px 24px;font-family: Helvetica, 'Microsoft YaHei', Arial, sans-serif;font-size: 18px;line-height: 26px;color: #272e47;font-weight: 400;">
                ...
                <div style="padding: 16px 24px; background: #fff; margin-bottom: 20px;">
